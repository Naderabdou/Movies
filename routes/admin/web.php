...
// home routes
        ...
        Route::any('/admins/bulk_delete', 'AdminController@bulkDelete')->name('admins.bulk_delete');

        Route::resource('admins', 'AdminController');

        //user routes
        Route::get('/users/data', 'UserController@data')->name('users.data');
        Route::any('/users/bulk_delete', 'UserController@bulkDelete')->name('users.bulk_delete');
