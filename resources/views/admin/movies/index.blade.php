    ...
    <script>
        ...
        let moviesTable = $('#movies-table').DataTable({
            ...
            columns: [
                ...
                {data: 'vote', name: 'vote', searchable: true, sortable: true, width: '5%'},
                {data: 'vote_count', name: 'vote_count', searchable: true, sortable: true, width: '5%'},
                ...
                {data: 'actions', name: 'actions', searchable: true, sortable: true, width: '20%'},
            ],
            order: [[4, 'desc']],
